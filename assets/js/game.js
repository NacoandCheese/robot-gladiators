// var playerName = user input for whatever name user chooses
...
var startGame = function () {
  ...
  //startGame();
  // after the loop ends, player is either out of health or enemies to fight, so run the endGame funtion
  endGame();
};
